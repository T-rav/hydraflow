...
created_at: 2026-07-18T04:11:59.906573+00:00
status: active
corroborations: 1
...
# Use `logger.warning(..., exc_info=True)` for transient, not `logger.exception()`
...
See also: gotchas — Use `log_exception_with_bug_classification()` to classify bugs vs transient.
