...
created_at: 2026-07-18T19:10:32.489190+00:00
status: active
corroborations: 1
...
In event dispatch tables, distinguish events that produce no display output but set a result value from events that are truly silent and set nothing.
