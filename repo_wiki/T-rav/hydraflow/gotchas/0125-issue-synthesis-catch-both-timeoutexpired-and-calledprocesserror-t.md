...
created_at: 2026-07-18T20:37:07.466660+00:00
status: active
corroborations: 1
...
Example: `except subprocess.TimeoutExpired: handle_timeout()` separate from `except subprocess.CalledProcessError: handle_failure()` — not a single `except CalledProcessError`.
