...
Example: add `from scripts.audit import score_rule` only after `score_rule` appears in the test function body. See also: testing — `feedback_ruff_strips_unused_imports_during_tdd.md`.
