...
created_at: 2026-07-26T10:44:02.164172+00:00
status: superseded
corroborations: 1
...
Example: an adapter failure or empty `added_paths` (merge commit, shallow clone) must leave the row untouched, not downgrade it.
