...
created_at: 2026-07-26T10:44:02.101101+00:00
status: superseded
corroborations: 1
...
Example: per `docs/standards/testing/README.md`'s three-layer pyramid, MockWorld scenarios exist to catch loop integration bugs; skip that layer when the change is single-method internal logic with no cross-phase effect.
