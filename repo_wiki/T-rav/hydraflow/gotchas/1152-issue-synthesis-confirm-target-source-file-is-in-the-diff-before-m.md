...
created_at: 2026-07-26T12:12:36.146520+00:00
status: active
corroborations: 1
...
Example: a PR closing an issue shows only `docs/` and `tests/` changed, while `src/makefile_scaffold.py` has 0 changes (issue #7644).
