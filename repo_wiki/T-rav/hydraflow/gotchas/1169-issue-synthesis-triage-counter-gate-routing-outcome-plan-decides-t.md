...
created_at: 2026-07-26T12:12:36.437081+00:00
status: active
corroborations: 1
...
Example: `_maybe_decompose(issue, result)` returning True sets `routing_outcome = "epic_decomposed"` (line 383) and short-circuits past that gate, so decomposed issues are deliberately excluded.
