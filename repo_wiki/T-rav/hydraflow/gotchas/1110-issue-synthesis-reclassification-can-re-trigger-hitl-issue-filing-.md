...
created_at: 2026-07-26T10:44:02.141107+00:00
status: superseded
corroborations: 1
...
Example: any `DETECTOR_GENERATION` rewind in `escape_ledger_loop.py` must include a test proving no double-filing across a reclassification.
