...
created_at: 2026-07-26T12:12:36.418732+00:00
status: active
corroborations: 1
...
# Parked epic children invisible to IssueStore — derive state from GH labels
...
Example: `EpicManager._build_detail` (`src/epic.py`) inspects child GitHub labels directly to classify an epic as `paused` when all children are parked, then memoizes the result.
