...
created_at: 2026-07-18T19:10:32.485450+00:00
status: active
corroborations: 1
...
**Why:** A required field with no default causes `ValidationError` on every existing persisted object, breaking recovery from saved state on restart.
