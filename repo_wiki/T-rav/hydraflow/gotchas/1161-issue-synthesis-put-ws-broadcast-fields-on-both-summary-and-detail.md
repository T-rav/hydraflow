...
created_at: 2026-07-26T12:12:36.416079+00:00
status: active
corroborations: 1
...
# Put WS-broadcast fields on both summary and detail model, not detail-only
...
Example: for issue #10299's `execution` field on `src/models.py`, it had to be added to BOTH `EpicProgress` and `EpicDetail`.
