...
created_at: 2026-07-18T14:59:29.446165+00:00
status: active
corroborations: 1
...
When testing that a loop tolerates port/runner failures, include a case asserting `CreditExhaustedError` is re-raised, not just swallowed.
...
See `test_review_phase_core.py:1919` for the full pattern.
