...
created_at: 2026-07-26T12:12:36.308089+00:00
status: active
corroborations: 1
...
Example: `tests/regressions/test_issue_10290.py` was authored before the fix for issue #10290 and had to reproduce the bug (infra parks sharing the 24h clarification floor) when run red. See also: this topic — "Regression tests must stay unmodified as acceptance gates".
