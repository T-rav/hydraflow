...
created_at: 2026-07-26T10:44:02.094540+00:00
status: active
corroborations: 1
...
**Why:** Duplicating harnesses per-ADR was flagged as a gotchas-audit risk; the shared parametrized table is the established pattern. See also: this topic — "ADR-drift right-sizing regression tests pin exact symbol owners".
