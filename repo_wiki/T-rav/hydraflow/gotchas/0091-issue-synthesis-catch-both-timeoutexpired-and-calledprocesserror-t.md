...
created_at: 2026-07-18T19:10:32.484701+00:00
status: active
corroborations: 1
...
Example: `except subprocess.TimeoutExpired: handle_timeout()` and `except subprocess.CalledProcessError: handle_failure()` as sibling clauses, not a single catch.
