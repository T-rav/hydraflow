...
created_at: 2026-07-18T19:10:32.482993+00:00
status: active
corroborations: 1
...
When removing multiple code blocks from the same file in a single session, delete the lowest block first and work upward.

Example: delete lines 120–130 before lines 80–90; reversing the order shifts targets for the second deletion.
