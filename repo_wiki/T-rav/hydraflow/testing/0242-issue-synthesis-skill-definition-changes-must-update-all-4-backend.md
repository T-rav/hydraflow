...
created_at: 2026-07-18T15:01:50.871426+00:00
status: active
corroborations: 1
...
HydraFlow skills replicate across `.claude/commands/`, `.pi/skills/`, `.codex/skills/`, and `src/*.py`. Validate marker presence via substring search across all 4 locations using a manual `SKILL_MARKERS` mapping (not regex introspection). A single skill change may require updating 3+ test fixture files.
