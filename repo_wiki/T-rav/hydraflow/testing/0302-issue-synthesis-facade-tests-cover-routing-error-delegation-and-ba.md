...
When testing a facade's `__getattr__`, verify four cases: correct method routing, nonexistent method raises `AttributeError`, protocol delegation satisfaction, and backward compat with existing mocks.
