...
created_at: 2026-07-18T18:34:51.001038+00:00
status: active
corroborations: 1
...
All tests that read or write files must use pytest's `tmp_path` combined with `ConfigFactory.create(base_path=tmp_path)`.
