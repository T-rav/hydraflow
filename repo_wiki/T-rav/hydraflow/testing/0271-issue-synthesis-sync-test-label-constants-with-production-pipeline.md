...
created_at: 2026-07-18T18:34:51.018566+00:00
status: active
corroborations: 1
...
Example: `assert set(VALID_TRANSITIONS.keys()) == VALID_STAGES`. Test both `EVENT_TYPE_TO_STAGE` and `SOURCE_TO_STAGE` paths independently. See also: testing — Test direct-swap labels via swap_pipeline_labels(), not transitions.
