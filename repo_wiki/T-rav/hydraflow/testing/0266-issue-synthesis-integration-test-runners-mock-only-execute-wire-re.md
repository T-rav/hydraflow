...
created_at: 2026-07-18T18:34:51.012018+00:00
status: active
corroborations: 1
...
In phase-runner integration tests, wire real `StateTracker`, `EventBus`, and judges. Mock only the `_execute()` subprocess boundary.
