...
created_at: 2026-07-26T12:17:07.553056+00:00
status: active
corroborations: 1
...
Example: `mock._execute.side_effect = FatalError(); with pytest.raises(FatalError): await loop.run_once()`. See also: architecture-async-control — error hierarchy.
