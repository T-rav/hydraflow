...
created_at: 2026-07-18T15:01:50.867722+00:00
status: active
corroborations: 1
...
When adding or removing fields, update: (1) model definition, (2) test factory defaults, (3) field-presence assertions, (4) serialization round-trip tests. Before committing, `grep -r "ModelName" tests/`. For `NotRequired` fields, update exact-match assertions but not missing-key assertions.
