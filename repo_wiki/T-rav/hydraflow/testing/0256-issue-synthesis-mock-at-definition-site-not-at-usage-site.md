...
created_at: 2026-07-18T18:34:50.993373+00:00
status: active
corroborations: 1
...
- For optional deps: `patch.dict("sys.modules", {"sentry_sdk": mock_sdk})`

**Why:** Usage-site patches intercept only one import; other callers see the real object, causing inconsistent test behavior.
