...
created_at: 2026-07-18T18:34:51.020333+00:00
status: active
corroborations: 1
...
Example: Before committing, grep for the model name: `grep -r "ModelName" tests/`. See also: testing — dict-to-TypedDict migrations require no new tests.
