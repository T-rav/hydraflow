...
created_at: 2026-07-18T04:14:32.512555+00:00
status: active
corroborations: 1
...
# Mock at definition site, not at import site
...
For optional deps like `sentry_sdk`, use `patch.dict("sys.modules", {"sentry_sdk": mock, "sentry_sdk.integrations": mock})` to guarantee teardown.

**Why:** Usage-site patches leave the original binding intact; other callers and subsequent imports still see the real object, producing inconsistent test behavior.
