...
created_at: 2026-07-28T19:46:33.809363+00:00
status: superseded
corroborations: 1
...
Repo wiki auditor scripts must be read-only — no --apply flag, no file mutation, stdout + optional --json only. A passing run leaves git status --porcelain repo_wiki/ empty. No MockWorld scenario or sandbox e2e needed.
