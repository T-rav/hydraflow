...
created_at: 2026-07-18T18:34:51.052355+00:00
status: active
corroborations: 1
...
When adding `Literal` constraints to Pydantic fields, test both valid and invalid values.

Example: For `status: Literal['open', 'closed']`, test `status='open'` passes and `status='unknown'` raises `ValidationError`.
