...
created_at: 2026-07-18T15:01:50.856059+00:00
status: active
corroborations: 1
...
Good: `patch('src.foo._cache')` — Bad: `patch('src.consumer._cache')`. For optional deps like `sentry_sdk`, use `patch.dict('sys.modules', {'sentry_sdk': mock, 'sentry_sdk.integrations': mock})`; patch sub-modules explicitly to prevent import leaks.
