...
created_at: 2026-07-31T18:40:36.883660+00:00
status: active
corroborations: 1
supersedes: 2123
---
...
Example: only unit tests across `tests/test_adr_drift.py`, `tests/test_adr_pre_validator.py`, `tests/test_adr_reviewer.py`, plus a `tests/regressions/` pin. See also: testing — ADR-text + static/unit test fixes skip MockWorld/e2e.
