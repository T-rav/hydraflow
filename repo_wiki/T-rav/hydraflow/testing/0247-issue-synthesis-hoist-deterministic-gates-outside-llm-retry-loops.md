...
created_at: 2026-07-18T04:14:32.525584+00:00
status: active
corroborations: 1
...
Run subprocess-based validation (coverage, linting) once after the LLM retry loop exits, not inside each retry iteration.
...
Only run the gate when the LLM produced a passing verdict.
