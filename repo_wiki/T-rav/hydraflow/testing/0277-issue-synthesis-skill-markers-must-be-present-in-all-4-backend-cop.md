...
created_at: 2026-07-18T18:34:51.029436+00:00
status: active
corroborations: 1
...
Validate marker presence via substring search across all 4 backend locations: `.claude/commands/`, `.pi/skills/`, `.codex/skills/`, and `src/*.py`.

Example: Use a manual `SKILL_MARKERS` mapping, not regex introspection.
