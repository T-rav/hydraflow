...
created_at: 2026-07-18T18:34:51.006282+00:00
status: active
corroborations: 1
...
When testing a facade's `__getattr__`, verify four cases: correct routing, nonexistent method raises `AttributeError`, protocol satisfaction via delegation, and backward compatibility.

Example:
1. Correct method routes to the right sub-client.
2. Nonexistent method raises `AttributeError`.
3. Delegation satisfies the protocol.
4. Existing mocks of the original class still pass.
