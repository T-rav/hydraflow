...
created_at: 2026-07-31T18:40:37.010901+00:00
status: active
corroborations: 1
supersedes: 2171
---
...
Example: attribution signal — 45 of 78 Accepted ADRs cite a test that never names them → folding into REAL flips 45 to WEAK and breaks `tests/test_adr_enforcement_completeness.py`. Instead: ratchet via a pinned shrink-only baseline.
