...
created_at: 2026-07-18T04:14:32.521481+00:00
status: active
corroborations: 1
...
Migrating `dict[str, Any]` to TypedDicts, or narrowing a parameter from `Any` to a specific type, requires no additional tests — the change is purely static. TypedDicts are plain dicts at runtime, so existing assertions continue to work. Verify via `make quality-lite` and `make test`.
