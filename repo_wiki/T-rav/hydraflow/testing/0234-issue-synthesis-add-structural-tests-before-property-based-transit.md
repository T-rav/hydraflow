...
created_at: 2026-07-18T04:14:32.519804+00:00
status: active
corroborations: 1
...
Before running property-based tests on a transition graph, add structural assertions: every target is a valid stage, every stage has a transition entry, no dangling references.
