...
created_at: 2026-07-18T15:01:50.869535+00:00
status: active
corroborations: 1
...
**Why:** Timing-based assertions are flaky; deterministic event counts make failures reproducible and expose real data loss.
