...
created_at: 2026-07-28T14:38:21.865661+00:00
status: active
corroborations: 1
supersedes: 1454
---
...
Example: in the live `repo_wiki/T-rav/hydraflow` corpus, 427 of 471 `left_on_primary` immediate targets are themselves superseded. Scoring against the intermediate would bucket ~90% of edges as `not_live` and produce a vacuously clean report.
