...
created_at: 2026-08-14T20:25:51.884778+00:00
status: active
corroborations: 1
supersedes: 2400
---
...
Example: assert every hook object whose `command` references `.claude/hooks/hf.` carries `_hydraflow: true`, and every referenced script exists on disk under `.claude/hooks/`.
