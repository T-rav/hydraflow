...
created_at: 2026-07-18T04:14:32.522349+00:00
status: active
corroborations: 1
...
Use identical string keys (`"review_insights"`, not `"review-insights"`) in both deduplication priority maps and bank-assembly pipelines. Fallback recall functions must try multiple field names (`learning`, `text`, `content`, `display_text`) when extracting text payloads.
