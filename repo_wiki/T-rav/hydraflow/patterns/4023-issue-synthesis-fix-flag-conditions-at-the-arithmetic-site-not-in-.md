...
created_at: 2026-08-16T17:41:44.269090+00:00
status: active
corroborations: 1
supersedes: 3876
---
...
Example: The zero-usage flag condition was fixed inside `if cum_calls - base_raw_calls > 0:` by adding `and raw_delta >= min_window_calls`, rather than filtering in the loop consumer. See also: [patterns] — Gate zero-usage flag and cost path on same floor.
