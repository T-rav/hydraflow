...
created_at: 2026-07-18T14:57:29.418165+00:00
status: active
corroborations: 1
...
Example: change `parse()` return type and grep + update all `result[0]` / `result[1]` unpack sites before committing. See also: patterns — Grep all call sites before changing a function signature.
