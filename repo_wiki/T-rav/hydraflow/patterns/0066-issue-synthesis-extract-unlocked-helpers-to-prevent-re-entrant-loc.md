...
created_at: 2026-07-18T14:57:29.428716+00:00
status: active
corroborations: 1
...
Example: `def update(self): with self._lock: self._update_unlocked()` — `batch_update` calls `_update_unlocked()` too. See also: patterns — Use `threading.Lock` for thread-pool code.
