...
created_at: 2026-07-18T14:57:29.448642+00:00
status: active
corroborations: 1
...
Example: `prompt_diff = diff[:max_diff] + "[truncated]"` — keep `full_diff = diff` for the coverage engine. Never rebind `diff` in place.
