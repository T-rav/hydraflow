...
created_at: 2026-08-14T12:50:03.653801+00:00
status: active
corroborations: 1
supersedes: 1660
---
...
Example: After removing a loop like `PrRedRepairLoop` from `functional_areas.yml`, run `make arch-regen`. Hand-editing reddens the `arch-regen.yml` CI check. See also: [patterns] — ADR citations must be symbol-qualified.
