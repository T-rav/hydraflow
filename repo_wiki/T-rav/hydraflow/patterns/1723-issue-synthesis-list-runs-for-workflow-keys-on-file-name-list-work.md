...
created_at: 2026-08-14T11:12:31.872971+00:00
status: superseded
corroborations: 1
supersedes: 1629
superseded_by: 1819
...
Example: `ports.py` and `pr_manager.py` docstrings must each name which identifier their read keys on. Querying `list_runs_for_workflow` with a display name returns `[]` plus one WARNING naming the namespace mistake.
