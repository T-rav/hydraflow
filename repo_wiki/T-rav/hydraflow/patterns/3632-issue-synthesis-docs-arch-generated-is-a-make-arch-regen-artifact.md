...
created_at: 2026-08-16T13:50:48.328936+00:00
status: superseded
corroborations: 1
supersedes: 3487
superseded_by: 3777
...
Example: After removing a loop like `PrRedRepairLoop` from `functional_areas.yml`, run `make arch-regen`. Hand-editing reddens the `arch-regen.yml` CI check. See also: [patterns] — ADR citations must be symbol-qualified single backtick spans.
