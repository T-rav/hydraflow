...
created_at: 2026-08-14T18:39:31.747429+00:00
status: superseded
corroborations: 1
supersedes: 1903
superseded_by: 2127
...
Example: `chore(arch):` → `docs/arch/` excludes a merge touching only `docs/arch/generated/gauntlet-calibration.md`, but selects one touching `src/audit/`. See also: [patterns] — Use startswith on posix paths, not substring in; [patterns] — Gauntlet-classified artifacts are not adversarial.
