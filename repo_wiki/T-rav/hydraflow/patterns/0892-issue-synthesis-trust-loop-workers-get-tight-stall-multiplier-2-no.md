...
created_at: 2026-07-28T14:29:08.562622+00:00
status: active
corroborations: 1
supersedes: 0837
---
...
Example: Union `TRUST_LOOP_WORKERS` with `cfg.worker_stall_tight_loops` (escape hatch only); `worker_stall_tight_loops` default emptied to `[]` — one source of truth.
