...
created_at: 2026-07-18T14:57:29.437878+00:00
status: active
corroborations: 1
...
Example: `if not self.dry_run: self.event_bus.publish(TRIAGE_ROUTING, ...)` — not emitted during dry-run. See also: patterns — Keep event publishing coupled with the condition that gates it.
