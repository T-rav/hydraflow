...
The 23 hook objects all reference `$CLAUDE_PROJECT_DIR/.claude/hooks/hf.*` — all HydraFlow-owned, all need the tag. The convention is documented in `.claude/hooks/README.md`.
