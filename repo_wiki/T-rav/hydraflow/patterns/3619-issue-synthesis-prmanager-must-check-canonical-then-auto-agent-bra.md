...
created_at: 2026-08-16T12:13:23.471892+00:00
status: superseded
corroborations: 1
supersedes: 3473
superseded_by: 3764
...
A fix pushed by an Auto-Agent session to `agent/auto-agent-<N>` (#11182) reads as "no PR" if only the canonical `agent/issue-<N>` is checked. Use a private helper that returns the first branch with an open PR; canonical wins on conflict.
