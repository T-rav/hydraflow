...
created_at: 2026-07-25T01:17:04.302376+00:00
status: active
corroborations: 1
supersedes: 0011,0012,0013,0014,0015
---

# ADR drift: fix bare citations by dropping `src/`, not adding `:Symbol`
...
**Why:** dropping the prefix removes the file from `source_files` entirely; adding a symbol tail keeps a false ownership claim alive. See also: architecture — ADR-drift shared-infra allowlist.
