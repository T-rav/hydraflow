...
created_at: 2026-08-15T07:06:05.818194+00:00
status: active
corroborations: 1
supersedes: 0167
---
...
Example: ADR-0106 mentioning `src/base_background_loop.py` causes `_citation_drifts` to false-positive on every unrelated touch; same shape as #10434 (ADR-0055) and #10441 (ADR-0106). See also: gotchas — ADR-drift shared-infra allowlist; dependencies — _follow_reexports reuses _collect_defined_symbols helper.
