...
created_at: 2026-08-21T11:38:32.593712+00:00
status: active
corroborations: 1
supersedes: 0276
---
...
Example: ADR-0106 mentioning `src/base_background_loop.py` causes `_citation_drifts` to false-positive on every unrelated touch. See also: dependencies — _follow_reexports reuses _collect_defined_symbols helper.
