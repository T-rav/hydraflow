...
source_issue: 10874
source_phase: plan
created_at: 2026-07-31T06:49:10.357855+00:00
status: active
corroborations: 1
---
...
- `src/models.py` typed `AdversarialState.pending_concerns` as `src.pending_concerns.Concern`
- `src/adversarial_retry_loop.py` built `pending_concerns.Concern`
- Result: two distinct class objects, live `ValidationError` in production
