...
created_at: 2026-07-24T15:48:50.079880+00:00
status: active
corroborations: 1
...
**Why:** prevents re-implementing append-only JSONL I/O per store (the concept-scatter finding from #10403) while keeping dedup opt-in instead of forced on every ledger.
