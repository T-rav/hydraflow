...
created_at: 2026-07-28T11:26:40.571183+00:00
status: active
corroborations: 1
supersedes: 0047
---
...
Example: ADR-0106 mentioning `src/base_background_loop.py` causes `_citation_drifts` to false-positive on every unrelated touch; same shape as #10434 (ADR-0055) and #10441 (ADR-0106). See also: gotchas — ADR-drift shared-infra allowlist.
