...
created_at: 2026-08-21T11:38:32.599522+00:00
status: active
corroborations: 1
supersedes: 0285
---
...
Example: `scripts/hydraflow_healthcheck/__main__.py` `fix` subcommand imports `is_mechanically_fixable` from `fixability.py` by public name. Non-mechanical check: CLI prints the check's `source` citation and exits nonzero without invoking the adapter.
