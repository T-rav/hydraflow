...
created_at: 2026-08-16T02:51:17.450301+00:00
status: active
corroborations: 1
supersedes: 0178
---
...
Example: `detect_hitl_low_severity_pileup` in `src/trust_fleet_anomaly_detectors.py` was added as a sixth detector in `src/trust_fleet_sanity_loop.py`. See also: dependencies — Extend DependabotMergeLoop for green-PR merging.
