...
class ConfigFactory:
    ...
    def create(
        *,
        ...
        release_confidence_mode: str = "off",
        confidence_auto_merge_threshold: float = 0.80,
        confidence_stage_threshold: float = 0.65,
        confidence_hold_threshold: float = 0.50,
        confidence_reject_threshold: float = 0.30,
        dora_max_rework_rate: float = 0.15,
        dora_max_change_failure_rate: float = 0.20,
        risk_high_diff_lines: int = 500,
        risk_critical_diff_lines: int = 1000,
        confidence_calibration_enabled: bool = False,
        confidence_calibration_interval: int = 14400,
        confidence_calibration_min_samples: int = 20,
        confidence_calibration_max_adjustment: float = 0.02,
        confidence_weight_complexity: float = 0.10,
        confidence_weight_plan_quality: float = 0.15,
        confidence_weight_delta_fidelity: float = 0.05,
        confidence_weight_review_clean: float = 0.20,
        confidence_weight_ci_clean: float = 0.15,
        confidence_weight_visual_clean: float = 0.10,
        confidence_weight_escalation_free: float = 0.05,
        confidence_weight_security_clean: float = 0.05,
        confidence_weight_history: float = 0.10,
        confidence_weight_rework_penalty: float = 0.05,
        stability_reflection_enabled: bool = False,
        stability_auto_adapt: bool = False,
    ):
        ...
        with ExitStack() as stack:
            ...
            return HydraFlowConfig(
                ...
                release_confidence_mode=release_confidence_mode,
                confidence_auto_merge_threshold=confidence_auto_merge_threshold,
                confidence_stage_threshold=confidence_stage_threshold,
                confidence_hold_threshold=confidence_hold_threshold,
                confidence_reject_threshold=confidence_reject_threshold,
                dora_max_rework_rate=dora_max_rework_rate,
                dora_max_change_failure_rate=dora_max_change_failure_rate,
                risk_high_diff_lines=risk_high_diff_lines,
                risk_critical_diff_lines=risk_critical_diff_lines,
                confidence_calibration_enabled=confidence_calibration_enabled,
                confidence_calibration_interval=confidence_calibration_interval,
                confidence_calibration_min_samples=confidence_calibration_min_samples,
                confidence_calibration_max_adjustment=confidence_calibration_max_adjustment,
                confidence_weight_complexity=confidence_weight_complexity,
                confidence_weight_plan_quality=confidence_weight_plan_quality,
                confidence_weight_delta_fidelity=confidence_weight_delta_fidelity,
                confidence_weight_review_clean=confidence_weight_review_clean,
                confidence_weight_ci_clean=confidence_weight_ci_clean,
                confidence_weight_visual_clean=confidence_weight_visual_clean,
                confidence_weight_escalation_free=confidence_weight_escalation_free,
                confidence_weight_security_clean=confidence_weight_security_clean,
                confidence_weight_history=confidence_weight_history,
                confidence_weight_rework_penalty=confidence_weight_rework_penalty,
                stability_reflection_enabled=stability_reflection_enabled,
                stability_auto_adapt=stability_auto_adapt,
            )
