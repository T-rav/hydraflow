...
class ConfigFactory:
    ...
    def create(
        *,
        ...
        use_quality_gate_in_review: bool = True,
        ...
        gateway_coverage_interval: int = 3600,
        gateway_coverage_enabled: bool = True,
        ...
        with ExitStack() as stack:
            ...
            return HydraFlowConfig(
                ...
                use_quality_gate_in_review=use_quality_gate_in_review,
                ...
                gateway_coverage_interval=gateway_coverage_interval,
                gateway_coverage_enabled=gateway_coverage_enabled,
