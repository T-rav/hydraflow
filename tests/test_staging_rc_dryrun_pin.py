...
class TestGithubOutput:
    ...
    def test_missing_output_path_does_not_crash(
        ...
        # With no `--github-output` and no $GITHUB_OUTPUT (the session scrub
        # in tests/conftest.py strips the runner's, #11562 — a hand-run of the
        # script off-runner), the verdict falls back to stdout instead of
        # crashing on a None path.
