...
async def test_fix_ci_empty_files_changed_when_no_commits(
    ...
    """After fix_ci() with no agent commits, result.files_changed is empty."""
    runner = _make_runner(config, event_bus)
    transcript = "No changes needed.\nVERDICT: APPROVE\nSUMMARY: CI already passing"
...
# ---------------------------------------------------------------------------
# files_changed empty — fix_review_findings()
# ---------------------------------------------------------------------------
...
async def test_fix_review_findings_empty_files_changed_when_no_commits(
    ...
    """After fix_review_findings() with no agent commits, result.files_changed is empty."""
    runner = _make_runner(config, event_bus)
