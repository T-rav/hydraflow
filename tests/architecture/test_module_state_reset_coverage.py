...
_DISPOSITION: dict[str, str] = {
    ...
    "src/workspace/_manager.py::_FETCH_LOCKS": "debt:per-repo fetch locks; leak holds stale asyncio.Lock",
    "src/workspace/_manager.py::_WORKTREE_LOCKS": "debt:per-worktree locks; leak holds stale asyncio.Lock",
