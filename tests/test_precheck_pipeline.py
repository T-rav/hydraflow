...
class TestParsePrecheckTranscript:
    ...
    def test_all_fields_present(self) -> None:
        ...
        risk, confidence, escalate, summary, parse_failed = parse_precheck_transcript(
            transcript
        )
        assert risk == "low"
    ...
    def test_missing_risk_defaults_to_medium(self) -> None:
        ...
        risk, _, _, _, parse_failed = parse_precheck_transcript(transcript)
        assert risk == "medium"
    ...
    def test_missing_confidence_defaults_to_zero(self) -> None:
        ...
        _, confidence, _, _, parse_failed = parse_precheck_transcript(transcript)
    ...
    def test_escalate_yes(self) -> None:
        ...
        _, _, escalate, _, _ = parse_precheck_transcript(transcript)
    ...
    def test_missing_escalate_only(self) -> None:
        ...
        _, _, escalate, _, parse_failed = parse_precheck_transcript(transcript)
        assert escalate is False
        assert parse_failed is True
