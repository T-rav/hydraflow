...
class TestRepoRuntimeInfo:
    def test_repo_runtime_info_has_expected_defaults(self):
...
class TestRepoRuntime:
    ...
    def test_runtime_repr_includes_slug(self, tmp_path):
...
class TestRepoRuntimeRegistry:
    ...
    @pytest.mark.asyncio
    async def test_remove_unregisters_runtime(self, tmp_path):
    ...
    def test_registry_repr_includes_runtime_count(self):
        registry = RepoRuntimeRegistry()
