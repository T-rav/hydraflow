...
FLUID also didn't arrive alone. The same spring produced two companion pieces, and the three only make full sense together. In March 2025 I published a case study analyzing 2,443 of my own ChatGPT conversations, going back to 2023, against a five-stage model I called the AI Decision Loop: frame, generate, judge, verify, refine. The data was honest to the point of self-incrimination. A third of my sessions never went past the model's first response. Of the loops I did complete, 27% skipped the critical-evaluation step. And the one behavior that almost guaranteed a completed loop, at 98%, was asking the AI to critique its own output. Then in April 2025 I published the theory underneath: *AI Coherence* argued that LLMs are coherence machines, not truth machines. They reconstruct plausibility from patterns; hallucination is incomplete anchoring, not malfunction; truth has to enter from outside the model, through grounding and verification. Put the two together and the conclusion that became HydraFlow is forced. If the model only ever produces plausibility, and human verification discipline measurably fails, even in someone who taught structured engineering practice for two decades, then verification cannot remain a personal virtue. It has to become structure: executable, continuous, impossible to skip. FLUID said what the code becomes. The case study said why vigilance can't hold it. The coherence paper said why the model can't hold it either. The factory is what the three imply.
...
I didn't arrive at that by intuition. I'd measured it, in myself, before HydraFlow existed: the March 2025 case study found my own validation discipline failing in a third of 2,443 AI sessions. If a TDD teacher's vigilance doesn't survive sustained contact with a fluent model, no review culture built on vigilance will.
...
**My prior writing — the lineage behind this essay:**
...
- *What I Learned from Analyzing 2500 of My Own ChatGPT Conversations* (March 2025) — <https://aibuddy.software/papers/2500_chatgpt_conversations_case_study.pdf> — the AI Decision Loop case study: 2,443 of my own sessions, 2023 onward, scored against a five-stage engagement model. The empirical half of the walls-over-vigilance bet: 34% of sessions never went past the first response, 27% of completed loops skipped critical evaluation, and sessions where I asked the AI to critique its own output completed the loop 98% of the time. That last number is the seed of the provocateur category.
- *AI Coherence: Meaning from Patterns, Not Memory* (April 2025) — <https://aibuddy.software/papers/AI_Coherence_A_Theory_of_Utility_in_Large_Language_Models.pdf> — the theory half: LLMs as coherence machines rather than truth machines, hallucination as incomplete anchoring rather than malfunction, external context as the gravity that bends output toward the verifiable. Why truth has to enter the system from outside the model — which is what the validation engine operationalizes.
