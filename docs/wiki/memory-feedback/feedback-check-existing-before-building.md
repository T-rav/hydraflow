...
description: '2026-08-18: I rebuilt an already-shipped feature (rung-0 ledger #11055) and overwrote it with a thinner version. Grep for the module/script BEFORE writing, especially when a roadmap says ''NOW''.'
status: pending
issue: null
promoted_in: null
wontfix_reason: null
