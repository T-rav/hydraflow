...
| [0121](0121-rails-manifest-and-drift-caretaker.md) | The repo charter (charter.yaml) + drift caretaker — conformance as data | Proposed |
...
| [0146](0146-sentry-is-the-error-backend.md) | Sentry is the error backend | Accepted |
