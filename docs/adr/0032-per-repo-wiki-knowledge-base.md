...
- `src/wiki_compiler/_compiler.py:WikiCompiler` — LLM synthesis (compile_topic, synthesize_ingest); the tracked-compile flow, the pairwise judgements and the model seam are mixins under `src/wiki_compiler/`
