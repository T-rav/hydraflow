...
- `src/human_steering.py:parse_directives`, `src/human_steering.py:apply_steering`, `src/human_steering.py:fenced_steering_guidance`, `src/human_steering_loop.py:HumanSteeringLoop`, `src/models.py:SteeringState`, `src/orchestrator.py:_apply_human_steering`, `src/config.py:human_steering_authorized_users`
