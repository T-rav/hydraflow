...
**Enforced by:**
pytest:tests/test_epic_manager.py
pytest:tests/test_post_merge_handler.py
...
- `src/issue_fetcher.py:IssueFetcher._get_collaborators` — collaborator cache TTL pattern
