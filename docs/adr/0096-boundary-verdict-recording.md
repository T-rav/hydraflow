...
- `src/triage_phase.py:TriagePhase._record_triage_verdict`: integration of `record_stage_verdict` at Triage decision sites.
...
- `src/plan_phase_flow.py`: integration of `record_stage_verdict` at Plan decision sites.
