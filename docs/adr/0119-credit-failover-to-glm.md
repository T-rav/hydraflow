...
- **No persistence (v1).** A restart mid-failover re-engages on the first cap. Cross-restart persistence is a possible follow-up if the re-engage cost proves material.
