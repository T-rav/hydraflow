...
Sandbox scenarios may not ship as placeholders. ADR-0065 requires removing
...
| D2 | Sandbox e2e tests must be executable contracts | ADR-0065 supersedes the old placeholder precedent; harness gaps are tracked as issues, not green tests. |
