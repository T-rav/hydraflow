...
- Low: 0
- Unscored: 0
- Most common Fails by criterion: [8, 3, 1]

## Inventory

| Prompt | Category | File:Line | Severity | Fails | Partials |
|---|---|---|---|---|---|
| `acceptance_criteria_build` | Adjacent | src/acceptance_criteria.py:134 | High | 3,4,8 | 1 |
| `acceptance_criteria_precheck` | Adjacent | src/acceptance_criteria.py:194 | High | 2,3,5,8 | 1 |
| `adr_drift_triage` | Adjacent | src/adr_drift_triage_llm.py:137 | High | 1,3,4,7,8 | — |
...
| `discover_completeness` | Adjacent | src/discover_completeness.py | High | 1,3,4,7,8 | — |
| `discover_expander` | Adjacent | src/discover_expander.py:57 | High | 3,4,8 | 1 |
| `disturbance_dampener` | Adjacent | src/disturbance_dampener_loop.py:178 | High | 1,3,4,5,8 | 2 |
| `entry_evidence` | Adjacent | src/entry_evidence_loop.py:64 | High | 1,3,4,7,8 | — |
| `intervention_classify` | Adjacent | src/intervention/classify.py:135 | High | 2,3,4,7,8 | — |
| `scope_check` | Adjacent | src/scope_check.py | High | 1,2,3,7,8 | — |
| `shape_coherence` | Adjacent | src/shape_coherence.py | High | 1,3,4,7,8 | — |
| `spec_match_requirements_gap` | Adjacent | src/spec_match.py:108 | High | 1,2,3,8 | — |
| `term_proposer` | Adjacent | src/term_proposer_llm.py:176 | High | 1,3,4,7,8 | — |
...
| `verification_judge_code_validation` | Adjacent | src/verification_judge.py:252 | High | 1,3,4,7,8 | — |
| `verification_judge_instructions_validation` | Adjacent | src/verification_judge.py:300 | High | 1,3,4,8 | — |
| `verification_judge_precheck` | Adjacent | src/verification_judge.py:364 | High | 3,4,8 | 1 |
| `verification_judge_refinement` | Adjacent | src/verification_judge.py:330 | High | 1,3,8 | 2 |
...
| `implement_spec_review` | Implement | src/implement_spec_reviewer.py:165 | High | 1,3,4,7,8 | — |
| `plan_compliance` | Plan | src/plan_compliance.py | High | 1,3,4,7,8 | — |
...
| `shape_runner_advocate` | Plan | src/shape_runner.py:545 | High | 1,3,4,7,8 | — |
| `shape_runner_critic` | Plan | src/shape_runner.py:591 | High | 1,3,4,5,8 | — |
| `shape_runner_turn` | Plan | src/shape_runner.py:346 | High | 1,3,4,6,8 | — |
| `audit_adjudicate` | Review | src/audit/adjudicate.py:60 | High | 3,4,7,8 | — |
| `pr_red_repair_dispatch` | Review | src/pr_red_repair_loop.py:753 | High | 1,3,4,8 | — |
...
| `review_advisor_midflight` | Review | src/review_advisor.py:1335 | High | 3,4,7,8 | 1,2 |
| `review_advisor_postverify` | Review | src/review_advisor.py:1066 | High | 3,4,6,7,8 | 2 |
| `review_advisor_preflight` | Review | src/review_advisor.py:1232 | High | 3,4,8 | 1 |
...
| `sandbox_failure_fixer` | Review | src/sandbox_failure_fixer_loop.py:202 | High | 1,3,4,8 | — |
| `ultra_review` | Review | src/ultra_review.py | High | 2,3,4,7,8 | — |
| `bug_reproducer` | Triage | src/bug_reproducer.py:199 | High | 3,4,8 | 1,2 |
| `decomposition_council_direction` | Triage | src/decomposition_council.py:201 | High | 3,4,7,8 | 1 |
| `decomposition_council_validation` | Triage | src/decomposition_council.py:290 | High | 1,3,4,6,7 | — |
| `issue_refinement_dup` | Triage | src/issue_refinement.py:392 | High | 7,8 | 1,3 |
| `issue_refinement_priority` | Triage | src/issue_refinement.py:457 | High | 1,7,8 | 3 |
...
src/issue_refinement.py:392 · Severity: **High**

Scores: #1 Partial · #2 Pass · #3 Partial · #4 Pass · #5 Pass · #6 N/A · #7 Fail · #8 Fail
...
src/issue_refinement.py:457 · Severity: **High**

Scores: #1 Fail · #2 Pass · #3 Partial · #4 Pass · #5 Pass · #6 N/A · #7 Fail · #8 Fail
...
Scores: #1 Partial · #2 Pass · #3 Fail · #4 Fail · #5 Pass · #6 N/A · #7 Fail · #8 Fail
...
Scores: #1 Fail · #2 Pass · #3 Fail · #4 Fail · #5 Pass · #6 Fail · #7 Fail · #8 Pass
...
Scores: #1 Fail · #2 Pass · #3 Fail · #4 Fail · #5 Pass · #6 Fail · #7 N/A · #8 Fail
...
Scores: #1 Pass · #2 Fail · #3 Fail · #4 Fail · #5 Pass · #6 N/A · #7 Fail · #8 Fail
...
Scores: #1 Partial · #2 Pass · #3 Fail · #4 Fail · #5 Pass · #6 N/A · #7 N/A · #8 Fail
...
Scores: #1 Pass · #2 Partial · #3 Fail · #4 Fail · #5 Pass · #6 Fail · #7 Fail · #8 Fail
...
Scores: #1 Partial · #2 Partial · #3 Fail · #4 Fail · #5 Pass · #6 N/A · #7 Fail · #8 Fail
...
Scores: #1 Fail · #2 Partial · #3 Fail · #4 Fail · #5 Fail · #6 N/A · #7 N/A · #8 Fail
...
- `issue_refinement_priority` (Triage) — request buried — model may misidentify task intent
...
- `plan_compliance` (Plan) — request buried — model may misidentify task intent
...
- `implement_spec_review` (Implement) — request buried — model may misidentify task intent
- `audit_adjudicate` (Review)
- `pr_red_repair_dispatch` (Review) — request buried — model may misidentify task intent
...
- `review_advisor_postverify` (Review) — long context placed after the request — degrades recall in long prompts
...
- `sandbox_failure_fixer` (Review) — request buried — model may misidentify task intent
- `ultra_review` (Review)
...
- `disturbance_dampener` (Adjacent) — request buried — model may misidentify task intent
- `entry_evidence` (Adjacent) — request buried — model may misidentify task intent
- `intervention_classify` (Adjacent)
- `scope_check` (Adjacent) — request buried — model may misidentify task intent
...
- `verification_judge_code_validation` (Adjacent) — request buried — model may misidentify task intent
