...
| ADR-0138 | `src.driver_contracts`, `src.gateway_control_reader`, `src.hydraflow_gateway.accounts`, `src.hydraflow_gateway.active_routes`, `src.hydraflow_gateway.models` | `pytest:tests/test_gateway_secret_absence.py`, `pytest:tests/test_gateway_accounts.py`, `pytest:tests/test_gateway_active_routes.py`, `pytest:tests/test_gateway_control_v2_read_api.py`, `pytest:tests/test_dashboard_gateway_routes.py`, `pytest:tests/scenarios/test_gateway_account_visibility_scenario.py` |
