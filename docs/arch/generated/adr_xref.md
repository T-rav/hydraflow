...
| ADR-0091 | — | — |
| ADR-0092 | `src.agent._prompts`, `src.preflight.runner`, `src.untrusted_text` | `pytest:tests/test_untrusted_text.py`, `pytest:tests/test_preflight_untrusted_fencing.py`, `pytest:tests/test_agent_cli.py`, `pytest:tests/test_agent_advanced.py` |
...
| ADR-0137 | `src.config`, `src.dashboard_routes._scheduling_routes`, `src.director_broker`, `src.director_dispatch`, `src.director_sandbox`, `src.director_shadow_log`, `src.director_turn_runner`, `src.driver_contracts`, `src.driver_journal`, `src.driver_manager`, `src.driver_ownership`, `src.driver_phase_adapters`, `src.fable_director`, `src.gateway_mint_client`, `src.hydraflow_gateway.keys`, `src.implement_broker`, `src.implement_worker_runner`, `src.issue_driver`, `src.issue_driver_policy`, `src.issue_store`, `src.models`, `src.plan_broker`, `src.plan_worker_runner`, `src.pr_manager`, `src.process_group`, `src.queue_strategy`, `src.route_enforcement`, `src.scheduling_model`, `src.state._driver` | `pytest:tests/test_driver_contracts.py`, `pytest:tests/test_director_capability_probe.py`, `pytest:tests/regressions/test_issue_11533_stale_driver_states.py`, `pytest:tests/test_issue_driver.py`, `pytest:tests/test_issue_driver_policy.py`, `pytest:tests/test_driver_manager.py`, `pytest:tests/test_scheduling_default_off.py`, `pytest:tests/regressions/test_issue_11535_kill_mid_transition.py`, `pytest:tests/test_director_sandbox.py`, `pytest:tests/test_director_broker.py`, `pytest:tests/test_fable_director.py`, `pytest:tests/test_director_shadow_default_off.py`, `pytest:tests/test_director_turn_runner_env.py`, `pytest:tests/test_dashboard_routes_scheduling.py`, `pytest:tests/architecture/test_director_no_authority.py`, `pytest:tests/regressions/test_issue_11537_shadow_safety.py`, `pytest:tests/regressions/test_issue_11537_shadow_idle_spin.py`, `pytest:tests/test_plan_broker.py`, `pytest:tests/test_plan_worker_runner.py`, `pytest:tests/test_plan_canary_default_off.py`, `pytest:tests/regressions/test_issue_11541_outside_the_slice.py`, `pytest:tests/scenarios/test_fable_plan_canary_scenario.py`, `pytest:tests/test_implement_broker.py`, `pytest:tests/test_implement_worker_runner.py`, `pytest:tests/test_implement_canary_default_off.py`, `pytest:tests/regressions/test_issue_11542_outside_the_slice.py`, `pytest:tests/scenarios/test_fable_implement_canary_scenario.py`, `pytest:tests/test_review_broker.py`, `pytest:tests/test_review_evidence.py`, `pytest:tests/test_review_authority.py`, `pytest:tests/test_review_worker_runner.py`, `pytest:tests/test_review_canary_default_off.py`, `pytest:tests/regressions/test_issue_11543_p5_review_seams.py`, `pytest:tests/regressions/test_issue_11543_outside_the_slice.py`, `pytest:tests/scenarios/test_fable_review_canary_scenario.py` |
...
| `src.adr_conformance` | ADR-0100, ADR-0143 |
...
| `src.agent._prompts` | ADR-0092 |
| `src.agent._runner` | ADR-0024, ADR-0027, ADR-0066, ADR-0103 |
...
| `src.auto_tighten.engine` | ADR-0143 |
...
| `src.charter` | ADR-0121, ADR-0143, ADR-0145 |
| `src.charter_drift_caretaker_loop` | ADR-0121 |
| `src.charter_model` | ADR-0121, ADR-0143 |
| `src.code_grooming_loop` | ADR-0065 |
| `src.config` | ADR-0002, ADR-0009, ADR-0010, ADR-0018, ADR-0021, ADR-0022, ADR-0031, ADR-0033, ADR-0034, ADR-0035, ADR-0036, ADR-0045, ADR-0050, ADR-0055, ADR-0065, ADR-0084, ADR-0094, ADR-0102, ADR-0106, ADR-0112, ADR-0137 |
| `src.config_trust_fleet_dials` | ADR-0103 |
...
| `src.director_dispatch` | ADR-0137 |
...
| `src.disturbance.baseline` | ADR-0101, ADR-0143 |
...
| `src.driver_contracts` | ADR-0137, ADR-0138, ADR-0139, ADR-0140, ADR-0141, ADR-0143 |
...
| `src.gate_activation_check` | ADR-0082, ADR-0143 |
...
| `src.health_monitor_loop._decisions` | ADR-0108 |
| `src.health_monitor_loop._loop` | ADR-0045 |
| `src.health_monitor_loop._stall` | ADR-0046, ADR-0106 |
...
| `src.implement_worker_runner` | ADR-0137 |
...
| `src.jsonl_ledger` | ADR-0126, ADR-0127, ADR-0143 |
