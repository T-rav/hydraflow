...
- **Executable fraction** (check-weighted): 99% (219 of 222 cited checks)
- **Check kinds:** pytest 218, make 1, script 0, prose 3
...
| ADR-0137 | Fenced IssueDriver and director runtime boundary | 100% | 27 | 0 |
...
| ADR-0143 | PAAA — Purpose, Articles, Actors, Artifacts — and the declare / decide / act seam | 100% | 3 | 0 |
