...
- **Executable fraction** (check-weighted): 99% (229 of 232 cited checks)
- **Check kinds:** pytest 228, make 1, script 0, prose 3
...
| ADR-0085 | Secrets never persist in the canonical audit stream | 100% | 3 | 0 |
...
| ADR-0137 | Fenced IssueDriver and director runtime boundary | 100% | 35 | 0 |
...
| ADR-0143 | PAAA — Purpose, Articles, Actors, Artifacts — and the declare / decide / act seam | 100% | 5 | 0 |
