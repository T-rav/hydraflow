...
- **Executable fraction** (check-weighted): 98% (161 of 164 cited checks)
- **Check kinds:** pytest 160, make 1, script 0, prose 3
...
| ADR-0138 | Gateway account identity and sanitized route visibility | 100% | 6 | 0 |
