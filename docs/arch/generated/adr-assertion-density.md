...
- **Executable fraction** (check-weighted): 99% (233 of 236 cited checks)
- **Check kinds:** pytest 232, make 1, script 0, prose 3
...
| ADR-0146 | Sentry is the error backend | 100% | 2 | 0 |
