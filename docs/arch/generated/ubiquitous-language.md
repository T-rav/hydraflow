...
**Kind:** `policy` · **Context:** `shared-kernel` · **Anchor:** `src/disturbance/registry.py:DimensionSpec` · **Confidence:** `accepted`
...
**Kind:** `port` · **Context:** `shared-kernel` · **Anchor:** `src/disturbance/detectors/base.py:ViolationDetector` · **Confidence:** `accepted`
