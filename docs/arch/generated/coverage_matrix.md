...
| `SandboxFailureFixerLoop` | ✅ [0052, 0063, 0101] | ✅ [dark-factory.md, disturbance-dampener-loop.md] | ✅ loops.md | ✅ README.md | ✅ `test_sandbox_failure_fixer_loop.py` | ✅ in catalog | ✅ `s38_sandbox_fixer_richer_context.py` |
