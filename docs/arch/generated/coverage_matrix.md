...
| `CharterDriftCaretakerLoop` | ✅ [0121] | ✅ [charter-drift-caretaker-loop.md] | ✅ loops.md | ❌ | ✅ `test_charter_drift_caretaker_loop.py` | ✅ in catalog | ✅ `s94_onboarding_writes_charter.py` |
