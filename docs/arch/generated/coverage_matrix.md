...
| `AdrDriftResolverLoop` | ❌ | ❌ | ✅ loops.md | ❌ | ✅ `test_adr_drift_resolver_loop.py` | ✅ in catalog | ❌ |
...
| `PrRedRepairLoop` | ❌ | ❌ | ✅ loops.md | ❌ | ✅ `test_pr_red_repair_loop.py` | ✅ in catalog | ✅ `s74_pr_red_repair_idle_poll.py` |
