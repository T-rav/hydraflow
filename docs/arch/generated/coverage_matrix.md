...
| `DisturbanceDampenerLoop` | ✅ [0095] | ✅ [dimension-baseline.md, disturbance-dampener-loop.md] | ❌ | ❌ | ✅ `test_disturbance_dampener_loop.py` | ✅ in catalog | ✅ `s50_disturbance_dampener_idle_poll.py` |
...
| `SandboxFailureFixerLoop` | ✅ [0052, 0063, 0095] | ✅ [dark-factory.md, disturbance-dampener-loop.md] | ✅ loops.md | ✅ README.md | ✅ `test_sandbox_failure_fixer_loop.py` | ✅ in catalog | ✅ `s38_sandbox_fixer_richer_context.py` |
