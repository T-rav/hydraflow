...
| ADR-0146 | enforced | `pytest:tests/test_sentry_observability_adapter.py::TestTheDsnIsTheSwitch::test_no_dsn_gets_the_no_op`, `pytest:tests/test_sentry_observability_adapter.py::TestErrorsOnly::test_tracing_is_initialised_off` |
...
| `pytest:tests/architecture/test_adr0143_decision_shape.py::test_blocking_is_an_orthogonal_field_not_a_status` | ADR-0143 |
...
| `pytest:tests/regressions/test_issue_11536_shadow_route_is_inert.py` | ADR-0139 |
...
| `pytest:tests/regressions/test_issue_11542_outside_the_slice.py` | ADR-0137 |
| `pytest:tests/regressions/test_issue_11543_outside_the_slice.py` | ADR-0137 |
| `pytest:tests/regressions/test_issue_11543_p5_review_seams.py` | ADR-0137 |
...
| `pytest:tests/scenarios/test_charter_purpose_drift_scenario.py::TestPurposeDrift::test_a_charter_that_lost_its_purpose_files_one_issue` | ADR-0143 |
...
| `pytest:tests/scenarios/test_fable_implement_canary_scenario.py` | ADR-0137 |
| `pytest:tests/scenarios/test_fable_plan_canary_scenario.py` | ADR-0137 |
| `pytest:tests/scenarios/test_fable_review_canary_scenario.py` | ADR-0137 |
...
| `pytest:tests/scenarios/test_gateway_route_shadow_scenario.py` | ADR-0139 |
...
| `pytest:tests/test_charter_purpose_presence.py::TestAnUnstatedPurposeIsDrift::test_a_charter_stating_no_product_is_drift` | ADR-0143 |
...
| `pytest:tests/test_dashboard_gateway_policy_routes.py` | ADR-0140 |
| `pytest:tests/test_dashboard_gateway_routes.py` | ADR-0138 |
| `pytest:tests/test_dashboard_routes_repo.py` | ADR-0007, ADR-0008 |
| `pytest:tests/test_dashboard_routes_scheduling.py` | ADR-0137 |
| `pytest:tests/test_dashboard_routes_state.py` | ADR-0134 |
| `pytest:tests/test_data_migration_d2.py` | ADR-0021 |
| `pytest:tests/test_director_broker.py` | ADR-0137 |
| `pytest:tests/test_director_capability_probe.py` | ADR-0137 |
| `pytest:tests/test_director_sandbox.py` | ADR-0137 |
| `pytest:tests/test_director_shadow_default_off.py` | ADR-0137 |
| `pytest:tests/test_director_turn_runner_env.py` | ADR-0137 |
...
| `pytest:tests/test_fable_director.py` | ADR-0137 |
...
| `pytest:tests/test_implement_broker.py` | ADR-0137 |
| `pytest:tests/test_implement_canary_default_off.py` | ADR-0137 |
| `pytest:tests/test_implement_phase.py` | ADR-0005, ADR-0024 |
| `pytest:tests/test_implement_worker_runner.py` | ADR-0137 |
...
| `pytest:tests/test_operator_identity.py` | ADR-0140 |
...
| `pytest:tests/test_review_authority.py` | ADR-0137 |
| `pytest:tests/test_review_broker.py` | ADR-0137 |
| `pytest:tests/test_review_canary_default_off.py` | ADR-0137 |
| `pytest:tests/test_review_evidence.py` | ADR-0137 |
...
| `pytest:tests/test_review_worker_runner.py` | ADR-0137 |
...
| `pytest:tests/test_routing_workspace.py` | ADR-0140 |
