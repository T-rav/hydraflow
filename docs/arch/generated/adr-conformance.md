...
| ADR-0137 | enforced | `pytest:tests/test_driver_contracts.py`, `pytest:tests/test_director_capability_probe.py`, `pytest:tests/regressions/test_issue_11533_stale_driver_states.py` |
| ADR-0138 | enforced | `pytest:tests/test_gateway_secret_absence.py`, `pytest:tests/test_gateway_accounts.py`, `pytest:tests/test_gateway_active_routes.py`, `pytest:tests/test_gateway_control_v2_read_api.py`, `pytest:tests/test_dashboard_gateway_routes.py`, `pytest:tests/scenarios/test_gateway_account_visibility_scenario.py` |
...
| `pytest:tests/test_gateway_accounts.py` | ADR-0138 |
| `pytest:tests/test_gateway_active_routes.py` | ADR-0138 |
