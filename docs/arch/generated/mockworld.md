...
| **FakeIssueStore** | `IssueStorePort` | `tests/scenarios/test_epic_replan_ownership_scenario.py`<br>`tests/scenarios/test_failed_escalation_leaves_no_phantom_stage_scenario.py`<br>`tests/scenarios/test_pipeline_boot_readiness_scenario.py`<br>`tests/scenarios/test_pipeline_snapshot_terminal_status_scenario.py` |
...
graph LR
    ...
    tests_scenarios_test_failed_escalation_leaves_no_phantom_stage_scenario_py([tests/scenarios/test_failed_escalation_leaves_no_phantom_stage_scenario.py]) --> FakeIssueStore
