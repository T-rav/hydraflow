...
| `issue_refinement` | `IssueRefinementLoop` | Repo Health | `background_model`, `issue_refinement_model` | ✅ | — | Backlog-wide duplicate detection, priority scoring, and a rolling operator digest issue. |
