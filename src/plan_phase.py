...
class PlanPhase:
    ...
    async def _handle_plan_success(self, issue: Task, result: PlanResult) -> None:
        ...
        # Req-ID: body line) into the plan comment ABOVE the --- separator,
        # so the implementer prompt (which extracts the plan up to the
        # separator; see agent.py) sees it and can thread Req-ID: trailers.
