...
def classify_regression_rot(
    ...
    *,
    ...
    - Issue state resolved per ``issue_state_is_resolved`` (COMPLETED /
      NOT_PLANNED, #11458) -> ``"false_close"`` (fires immediately — a
      closed issue with a still-RED pin is a contradiction regardless of
