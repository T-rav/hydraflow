...
HYDRAFLOW_LABELS: tuple[tuple[str, str, str], ...] = (
    ...
    ("flaky_test_label", "fbca04", "Persistently flaky test"),
    ("flaky_test_stuck_label", "b60205", "Flaky test unresolved after retries"),
    ("fake_drift_label", "fbca04", "Fake replay drift after contract refresh"),
    ("fake_repair_stuck_label", "b60205", "Fake repair unresolved after retries"),
    (
        "corpus_learning_stuck_label",
        "b60205",
        "Corpus learning validation unresolved after retries",
    ),
    ("trust_loop_anomaly_label", "d93f0b", "Trust fleet anomaly escalation"),
    ("rc_duration_regression_label", "fbca04", "RC duration regression"),
    ("rc_duration_stuck_label", "b60205", "RC duration regression unresolved"),
    ("wiki_rot_label", "fbca04", "Repo wiki cite drift"),
    ("wiki_rot_stuck_label", "b60205", "Wiki rot unresolved after retries"),
    ("skill_prompt_case_weak_label", "fbca04", "Weak skill prompt corpus case"),
    ("skill_prompt_stuck_label", "b60205", "Skill prompt drift unresolved"),
    ("discover_stuck_label", "b60205", "Discover evaluator unresolved"),
    ("shape_stuck_label", "b60205", "Shape evaluator unresolved"),
    ("shadow_drift_label", "fbca04", "Shadow corpus drift finding"),
    ("shadow_drift_stuck_label", "b60205", "Shadow corpus drift unresolved"),
    ("principles_drift_label", "fbca04", "Managed-repo principles drift"),
    ("principles_stuck_label", "b60205", "Principles drift unresolved"),
    ("cultural_check_label", "d4c5f9", "Cultural principles audit check"),
    ("staging_revert_conflict_label", "b60205", "Auto-revert hit conflicts"),
    (
    ...
    (
        ...
        "b60205",
        "RC still red after auto-revert",
    ),
    (
        "staging_rc_red_verify_timeout_label",
        "b60205",
        "RC verification timed out after auto-revert",
    ),
    ("staging_rc_red_retry_label", "fbca04", "Staging retry issue"),
    (
        "adr_drift_label",
        "5319e7",
