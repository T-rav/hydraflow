...
export function Header({ connected, orchestratorStatus }) {
  const {
    ...
    reporterId,
    startOrchestrator,
    stopOrchestrator, advisoryNotices, dismissAdvisoryNotice, dismissAllAdvisoryNotices } = useHydraFlow()
  ...
  return (
    <header style={styles.header}>
      ...
      <div style={styles.controls}>
        ...
        <NoticeBell
          notices={advisoryNotices}
          onDismiss={dismissAdvisoryNotice}
          onDismissAll={dismissAllAdvisoryNotices}
        />
        <button
