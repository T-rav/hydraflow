...
export function ReportIssueModal({ isOpen, screenshotDataUrl, onSubmit, onClose }) {
  ...
  // Load screenshot into canvas when opened
  useEffect(() => {
    if (!isOpen || !screenshotDataUrl || !canvasRef.current) return
  ...
  const handleSubmit = useCallback(async () => {
    ...
    setSubmitting(false)
    onClose()
  }, [description, submitting, onSubmit, onClose])
  ...
  return (
    <div style={styles.overlay} onClick={handleBackdropClick} data-testid="report-modal-overlay">
      <div style={styles.card} data-testid="report-modal-card">
