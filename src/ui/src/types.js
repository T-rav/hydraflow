 ...
 *
 * @typedef {{ name: string, status: string, last_run: string|null, interval_seconds: number|null, watchdog_timeout_seconds: number|null, next_run: string|null, details: Record<string, any> }} BackgroundWorkerState
 *
